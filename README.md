...
**内部人才研究、简历评估与知识管理工具**（界面名"智谱人才雷达" / AGI Talent Radar）

</div>

## 功能

- **人才评估**：统一评估入口（`/talent-evaluation`），左侧候选人文件夹 + 共用简历导入
  - **面试准入**：候选人 × JD 显式配对，岗位评估卡核心任务 0–4 能力等级 + 可追溯证据 → 进入面试 / 不进入面试
  - **能力评估**：候选人级能力结构工作流（重构中，当前展示结构化简历，不提供总分）
- **人才问答**：自然语言提问，AI Agent 自动检索人才库、查论文、查舆情，生成调查报告
- **人才库**：统一档案管理、关系图谱可视化、分组收纳、对比滑轨、版本对比
- **JD 池**：JD 与补充要求管理，自动生成岗位评估卡（无激活状态，仅批次启动时显式选择）
