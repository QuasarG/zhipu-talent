...
COMMON_RUBRIC = (
    ...
    D("ownership", "Ownership 与贡献边界", 7, "看项目或实习/工作中本人提出、设计、实现、维护和推进范围；岗位名与机构档位不代表 ownership。"),
    D("evidence_credibility", "证据可信度与可复现性", 7, "看条件、数据、指标、产物和可核验性。正式同行评议成果、高含金量验收、可运行产物或可核验生产指标应加分；机构名气和拟投状态不构成强证据。"),
