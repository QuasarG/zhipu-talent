...
export default function EvaluationWorkspace({ candidateId = "none", evaluation, evaluationRun, academicReport, graph, liveNodeRuns, evaluating }: Props) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto pt-4 pr-1">
        {tab === "result" ? (
          evaluation ? <ScoreOverview evaluation={evaluation} academicReport={academicReport} /> : <ResultEmpty evaluating={evaluating} />
        ) : (
          <EvaluationProcess
            graph={graph}
