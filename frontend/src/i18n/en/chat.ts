...
"思考中…": "Thinking…",
  ...
  "输入姓名即可让 AI Agent 自动检索人才库、查论文、查舆情，生成调查报告。上下文取决于调用的模型。":
    "Type a name and the AI agent automatically searches the Talent Pool, papers, and reputation to build an investigation report. Context length depends on the model in use (currently GLM-5.3-FlashX[1M]).",
